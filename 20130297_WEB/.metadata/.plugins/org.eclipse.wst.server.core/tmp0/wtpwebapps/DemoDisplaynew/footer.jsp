...
<body>
		<div class="footer">
			<div class="footer-top">
				<div class="container">
					...
					<div class="col-md-4 footer-in">
						...
						<p>Website được chạy trên nhiều nền tảng, với trụ sở chính ở: 145 tt Dầu Tiếng,huyện Dầu Tiếng, Tỉnh Bình Dương</p>
					</div>
			...
			<div class="footer-middle">
				<div class="container">
					<div class="footer-middle-in">
						...
						<p>Số 145 tt Dầu Tiếng,huyện Dầu Tiếng, Tỉnh Bình Dương
						<br>Hotline: 0353799530.
						</p>
			...
			Web design by PHAM HOANG KHUONG
			<br>
			&copy;2022 Website sales </p>
